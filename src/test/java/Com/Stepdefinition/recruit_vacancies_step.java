...
public class recruit_vacancies_step 
{
	...
	public void user_launch_the_chrome_browser14() throws Throwable {
	   b.ChromeLaunch();
	}

	@When("^User open the orange hrm login page14$")
	public void user_open_the_orange_hrm_login_page14() throws Throwable {
	    b.OrangeHRM_Homepage();
	}

	@Then("^User enter the username and password with valid data14$")
	public void user_enter_the_username_and_password_with_valid_data14() throws Throwable {
	  b.LoginDetails();
	}
