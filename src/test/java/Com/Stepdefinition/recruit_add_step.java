...
public class recruit_add_step 
{
	...
	public void user_Launch_the_chrome_browser13() throws Throwable {
	   add.ChromeLaunch();
	}

	@When("^User Open the orange hrm login page13$")
	public void user_Open_the_orange_hrm_login_page13() throws Throwable {
	    add.OrangeHRM_Homepage();
	}

	@Then("^User Enter the username and password with valid data13$")
	public void user_Enter_the_username_and_password_with_valid_data13() throws Throwable {
	   add.LoginDetails();
	}
