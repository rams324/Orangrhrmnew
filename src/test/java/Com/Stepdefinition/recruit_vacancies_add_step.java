...
public class recruit_vacancies_add_step 
{
	...
	public void user_Launch_the_Chrome_browser15() throws Throwable {
	    c.ChromeLaunch();
	}

	@When("^User Open the Orange hrm login page15$")
	public void user_Open_the_Orange_hrm_login_page15() throws Throwable {
	   c.OrangeHRM_Homepage();
	}

	@Then("^User Enter the Username and password with valid data15$")
	public void user_Enter_the_Username_and_password_with_valid_data15() throws Throwable {
	   c.LoginDetails();
	}
