...
import Com.pages.adding_details;
...
public class adding_detailsSD 
{
	...
	public void user_launch_the_chrome_browser6() 
	{
	...
	public void user_open_the_orange_hrm_login_page6()
	{
		page2.orangeHRM_homePage2();
	}
	@Then("^login with valid details6$")
	public void login_with_valid_details6() throws IOException, InterruptedException 
	{
