...
public class recruit_reset_step 
{
	...
	public void the_user_Launch_the_chrome_browser12() 
	{
	   a.ChromeLaunch();
	}

	@When("^the user Open the orange hrm login page12$")
	public void the_user_Open_the_orange_hrm_login_page12()
	{
	  a.OrangeHRM_Homepage();
	}

	@Then("^the user Enter the username and password with valid data12$")
	public void the_user_Enter_the_username_and_password_with_valid_data12() 
	{
	    a.LoginDetails();
	}
